...
import com.cunoc.edu.gt.data.pagination.Iterable;
import com.cunoc.edu.gt.utils.Assert;
import com.cunoc.edu.gt.utils.StreamUtils;
...
public interface Streamable<T> extends Iterable<T>, Supplier<Stream<T>> {
    ...
    /**
     * Returns a {@link Streamable} for the given {@link java.lang.Iterable}.
     *
    ...
    /**
     * Creates a non-parallel {@link Stream} of the underlying {@link java.lang.Iterable}.
     *
    ...
    /**
     * Creates a new {@link Streamable} from the current one and the given {@link java.lang.Iterable} concatenated.
     *
     * @param iterable must not be {@literal null}.
     * @return will never be {@literal null}.
     * @since 2.2
     */
    default Streamable<T> and(java.lang.Iterable<? extends T> iterable) {
     ...
     * {@link #and(java.lang.Iterable)} and {@link #and(Supplier)}.
     *
     ...
     */
    @SuppressWarnings("unchecked")
    public static <S, T extends java.lang.Iterable<S>> Collector<S, ?, Streamable<S>> toStreamable(
